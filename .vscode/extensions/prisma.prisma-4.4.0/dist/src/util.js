...
function checkForOtherPrismaExtension() {
    const files = (0, fs_1.readdirSync)(path_1.default.join((0, os_1.homedir)(), '.vscode/extensions')).filter((fn) => fn.toLowerCase().startsWith('prisma.prisma-') && !fn.toLowerCase().startsWith('prisma.prisma-insider-'));
    if (files.length !== 0) {
